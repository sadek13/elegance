...
function numberToWords(num) {
    ...
    if (decimalPart > 0) {
        decimalPart = parseFloat(decimalPart.toFixed(4));
...
console.log(numberToWords(1111111.551)); // Outputs: one billion two hundred thirty-four million five hundred sixty-seven thousand eight hundred ninety and 55/100
